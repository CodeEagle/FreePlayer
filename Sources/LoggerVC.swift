...
//    import SystemEnhancement
    ...
    public final class FPLoggerVC: UIViewController {
        ...
        private lazy var _switchGroup: UIView = {
            let h = CGFloat(44)
            ...
            label.font = UIFont.freeFont(of: 18, weight: .thin)
        ...
        private lazy var _logFolder: UIView = {
            let h = CGFloat(44)
            let w = UIScreen.main.bounds.width
            ...
            label.clipsToBounds = true
            label.isOpaque = false
            swi.font = UIFont.freeFont(of: 30, weight: .thin)
    ...
    private final class LogFileDetail: UIViewController, MFMailComposeViewControllerDelegate {
        ...
        override func viewDidLoad() {
            ...
            navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .reply, target: self, action: #selector(LogFileDetail.sendEmailButtonTapped))
        }
    ...
    private final class LogTextView: UIView, UITextFieldDelegate {
        ...
        private lazy var _textView: UITextView = {
            let tv = UITextView()
            tv.isEditable = false
            tv.font = UIFont.freeFont(of: 11, weight: .thin)
        ...
        private lazy var _filterTextInput: UITextField = {
            ...
            tf.font = UIFont.freeFont(of: 16, weight: .light)
    ...
    public extension UIFont {
        ...
        public class func freeFont(of size: CGFloat, weight: FontWeight = .regular) -> UIFont {
            var size = size
            let total = [UIScreen.main.bounds.width, UIScreen.main.bounds.height]
            if total.contains(375) {
                size += 1
            } else if total.contains(414) {
                size += 2
            }
            return systemFontOfSize(size: size, weight: weight)
        }
        
        @available(iOS 7, *)
        public class func systemFontOfSize(size: CGFloat, weight: FontWeight) -> UIFont {
            if #available(iOS 8.2, *) {
                let fontWeightFloat: CGFloat
                switch weight {
                case .ultraLight: fontWeightFloat = UIFont.Weight.ultraLight.rawValue
                case .light: fontWeightFloat = UIFont.Weight.light.rawValue
                case .thin: fontWeightFloat = UIFont.Weight.thin.rawValue
                case .regular: fontWeightFloat = UIFont.Weight.regular.rawValue
                case .medium: fontWeightFloat = UIFont.Weight.medium.rawValue
                case .semibold: fontWeightFloat = UIFont.Weight.semibold.rawValue
                case .bold: fontWeightFloat = UIFont.Weight.bold.rawValue
                case .heavy: fontWeightFloat = UIFont.Weight.heavy.rawValue
                case .black: fontWeightFloat = UIFont.Weight.black.rawValue
                }
                return systemFont(ofSize: size, weight: UIFont.Weight(rawValue: fontWeightFloat))
            } else {
                let systemFontName: String
                switch weight {
                case .ultraLight: systemFontName = "HelveticaNeue-UltraLight"
                case .light: systemFontName = "HelveticaNeue-Light"
                case .thin: systemFontName = "HelveticaNeue-Thin"
                case .regular: systemFontName = "HelveticaNeue"
                case .medium: systemFontName = "HelveticaNeue-Medium"
                case .semibold: systemFontName = "HelveticaNeue-Medium"
                case .bold: systemFontName = "HelveticaNeue-Bold"
                case .heavy: systemFontName = "HelveticaNeue-Bold"
                case .black: systemFontName = "HelveticaNeue-Bold"
                }
    ...
    extension UIApplication {
        ...
        public class func showDetail(_ vc: UIViewController?) {
            guard let value = vc else { return }
            topMostViewController?.showDetailViewController(value, sender: nil)
        }
    }
    ...
    extension CALayer {
        ...
        @discardableResult public func addSeperator(_ offsetX: CGFloat = 0, isBottom: Bool = false, color: UIColor = UIColor.lightGray, height: CGFloat = 0.5, y: CGFloat? = nil) -> CALayer {
            let layer = CALayer()
            var f = frame
            f.origin.x = offsetX
            f.origin.y = y ?? (isBottom ? f.size.height - height : 0)
            f.size.height = height
            f.size.width = UIScreen.main.bounds.width
            f.size.width -= offsetX
            layer.frame = f
